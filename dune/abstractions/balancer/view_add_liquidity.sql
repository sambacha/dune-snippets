CREATE OR REPLACE VIEW balancer.view_add_liquidity AS SELECT a.caller
    ...
    a.evt_block_time AS block_time FROM balancer
        ."BPool_evt_LOG_JOIN" a LEFT JOIN erc20.tokens t ON t
        .contract_address = a."tokenIn" LEFT JOIN prices.usd p ON
