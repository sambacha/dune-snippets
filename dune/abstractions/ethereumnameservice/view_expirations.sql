CREATE OR REPLACE VIEW ethereumnameservice.view_expirations AS SELECT label,
    ...
    count (*) AS count
    FROM (SELECT numeric2bytea (id) AS label, expires,
          evt_block_time FROM ethereumnameservice
              ."BaseRegistrarImplementation_evt_NameRegistered" UNION SELECT
